...
parcelRequire = function (e, r, n, t) {
  ...
  "lD1s": [function (require, module, exports) {
    var e = require("./helpers"),
        ...
        p = function () {
      var e = r("div");
      return e.classList.add("wrapper"), e;
    }();
  ...
  "cJDT": [function (require, module, exports) {
    var t = "background-color: #333; color: #eee; margin: 0; padding: 0;",
        n = function () {
      function n() {}
  ...
  "Focm": [function (require, module, exports) {
    var e = document.querySelector("#app"),
        ...
        q = new a(),
        t = new d(),
        l = new u("&copy; WCCI 2018"),
        m = require("./helpers"),
        H = m.makeElement;

    n.innerHTML += q.render(), n.innerHTML += t.render(), n.innerHTML += l.render(), e.appendChild(n);
  }, {
    "./appWrapper": "lD1s",
    "./header": "cJDT",
    "./main": "epB2",
